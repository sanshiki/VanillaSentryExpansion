...
{
    public class MothronQueenTurretStaff : ModItem
    {
        public override string Texture => ModGlobal.MOD_TEXTURE_PATH + "Items/MothronQueenTurretStaff";
        ...
        public override void SetDefaults()
        {
            ...
            // Item.buffType = ModContent.BuffType<MothronQueenTurretStaffBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<MothronQueenTurret>(); // This item creates the minion projectile
